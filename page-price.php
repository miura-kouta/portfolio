        ...
        <section id="price" class="price">
            ...
            <div class="price__cautionWrap">
                ...
                <ul class="price__cautionMenu">
                    <li class="price__cautionItem">・当方の不備による修正：回数に関係なく無料で対応いたします。お客様にご迷惑をおかけしないよう、誠意をもって迅速に対応いたします。
                    </li>
                    <li class="price__cautionItem">
                        ・検収後（納品完了後）の修正対応について：1ヶ月以内に限り、3回まで無料で対応いたします。1ヶ月を過ぎた修正や4回目以降の修正に関しては、別途料金が発生いたしますので、予めご了承ください。
                    </li>
                    <li class="price__cautionItem">
